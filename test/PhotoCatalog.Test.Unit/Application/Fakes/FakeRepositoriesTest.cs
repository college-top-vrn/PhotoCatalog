...
public class FakeRepositoriesTests
{
    ...
    {
        // Arrange
        (bool isSuccess, Album? album, _) = Album.Create(0, TODO);
    ...
    {
        // Arrange
        Result<Album> createResult = Album.Create(0, TODO);
    ...
    {
        // Arrange
        Result<Album> createResult = Album.Create(999, TODO);
        Assert.True(createResult.IsSuccess);
    ...
    {
        // Arrange
        Result<Album> album1 = Album.Create(0, TODO);
        Result<Album> album2 = Album.Create(0, TODO);
